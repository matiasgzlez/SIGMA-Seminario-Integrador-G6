...
- **Project board:** `SIGMA — Roadmap G6` (nº 4) — 40/40 issues activos cargados ✅
...
**Resultado:** HU-1 … HU-34 sin duplicados ni huecos · Project board con **40/40** issues activos · Sprint 1 muestra sus 8 HU.
