...
> **Un consejo único que agrupe a toda la informática.** Acá tuvimos que corregirnos a mitad del trabajo. Habíamos escrito que no existe matrícula de alcance nacional, y no es cierto: existe el **COPITEC**, Consejo Profesional de Ingeniería de Telecomunicaciones, Electrónica y Computación, creado por el Decreto-Ley 6070/58 y ratificado por la Ley 14.467, con jurisdicción nacional. Lo que no hay es un consejo único: la matrícula se reparte entre COPITEC y los consejos provinciales, cada uno con su alcance, y quien ejerce tiene que averiguar cuál le corresponde. Sobre eso volvemos en los puntos 8.5 y 9.
...
Conviene aclarar antes cuál es la pregunta. Como vimos en el punto 6.3, para actuar ante la justicia nacional la matrícula la da COPITEC. Pero COPIPACH tiene «el manejo exclusivo de la matrícula en la Provincia del Chaco» para el ejercicio dentro de esa jurisdicción. O sea que la pregunta no es si existe alguna matrícula posible (existe), sino **cuál rige para quien ejerce y perita acá**.
...
Y hay una prueba de que esto no es teórico. Para inscribirse como perito ante la **Justicia Nacional**, un egresado de nuestra carrera tiene que pasar por COPITEC, que admite expresamente a «ingenieros electromecánicos, electrónicos, en telecomunicaciones, **en sistemas, en informática o en computación, Analistas y Licenciados en Sistemas / Informática / Computación**». Le exige dos cosas: matrícula al día sin sanciones, y que el título **acredite explícitamente competencia para «realizar pericias y tasaciones»**. Por eso pide, junto al diploma, el plan de estudios y el documento de alcances e incumbencias.

> ### Por qué esto cierra el artículo
> Alguien que revisa expedientes, en una oficina del Poder Judicial, abre el papel de incumbencias de un egresado de sistemas y **busca ahí la actividad reservada n.º 11**. Si no está, no lo inscribe.
> Todo lo que venimos sosteniendo desde el punto 4 (que esas líneas de la Resolución 786/2009 no son una formalidad administrativa sino una habilitación con efectos concretos) tiene ahí su comprobación más directa. No hizo falta que lo dijera un doctrinario: lo verifica un empleado judicial cada vez que alguien se anota.
...
7. **La actividad reservada n.º 11 tiene efecto operativo comprobable.** Para inscribirse como perito ante la Justicia Nacional hay que presentar el documento de incumbencias del título y que allí figure la competencia para realizar pericias y tasaciones. Es decir: alguien, en una oficina judicial, lee esa línea de la Resolución 786/2009 y de ella depende que uno pueda peritar o no. Es la comprobación más concreta que encontramos de que las actividades reservadas no son una formalidad.
8. **Ciberseguridad y peritaje son la misma incumbencia en dos tiempos.** Quien diseña los controles y quien produce la prueba de lo ocurrido ejercen la misma competencia técnica, reconocida por el mismo acto administrativo, en momentos distintos del ciclo de vida de un incidente.
...
2. **La lectura de la Ley 2955-C es nuestra.** Los artículos 1, 4, 31 y 45 los transcribimos del texto publicado por el propio Consejo, y la comparación con Santa Fe y con el criterio de COPITEC apunta en el mismo sentido, pero la conclusión de que la ley chaqueña alcanza a Ingeniería en Sistemas de Información sigue siendo una interpretación nuestra. Puede haber resoluciones de la Comisión Directiva o prácticas de matriculación que no constan en el texto. **Sólo COPIPACH puede confirmarlo**. Conviene medir bien qué queda en juego: lo que está en discusión no es *si* existe una matrícula para nuestro título (existe, y COPITEC la otorga para actuar ante la justicia nacional) sino *cuál* corresponde para ejercer y peritar dentro de la provincia.
...
Decreto-Ley 6070/58, ratificado por la Ley 14.467, que crea el Consejo Profesional de Ingeniería de Telecomunicaciones, Electrónica y Computación (COPITEC), con jurisdicción nacional. Requisitos de inscripción como auxiliar de la justicia de la Nación publicados por el propio Consejo, año 2026.
